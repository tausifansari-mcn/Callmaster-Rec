  ...
  return (
    <section className="page active">
      <div className="container">
        <PageHero icon="voice" title="Hear Your Bot Call You — Before You Buy It.">
        ...
        <Section style={{ paddingTop: 0 }}>
          <h2>How it works</h2>
          <BulletList items={[
            'Choose your industry and the type of calls — Inbound, Outbound, Collections, Abandoned Cart Recovery, and more',
            'Choose Male or Female, then a language/accent — English, Hindi, Hinglish, British English, American English',
            'Enter your number, verify with OTP, and hit Call Me',
          ]} />
        </Section>
